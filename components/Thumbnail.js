...
const Thumbnail = forwardRef(({ result }, ref) => {
  ...
  return (
    <div ref={ref} className='group cursor-pointer p-5 transition durartion-200
    ease-in transform sm:hover:scale-105 hover:z-50'>
        ...
        <div className='p-2 '>
            ...
            <p className='flex items-center opacity-0 group group-hover:opacity-100'>
                {results.media_type && `${result.media_type} + `}{""}
